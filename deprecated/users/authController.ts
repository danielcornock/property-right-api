...
//* SIGN UP NEW USER
//*---------------------------------------------
export const signup = catchAsync(async (req: IRequest, res: IResponse, next: INext) => {
...
//*---------------------------------------------
export const login = catchAsync(async (req: IRequest, res: IResponse, next: INext) => {
...
//*---------------------------------------------
export const authGuard = catchAsync(async (req: IRequest, res: IResponse, next: INext) => {
  let token;
